          ...
          <div className="flex flex-wrap justify-center gap-3">
            {services.map((s) => (
              <a
                key={s.id}
                href={`#${s.id}`}
                className="px-4 py-2 rounded-lg bg-white/15 border border-white/25 text-white text-sm hover:bg-white/25 transition-colors"
              >
                {s.title}
              </a>
            ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
              ...
              <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-xs font-bold text-brand-bright uppercase tracking-widest">
                    {service.tagline}
                  </span>
                </div>
                ...
                {/* Why It Matters — left-border accent style */}
                <div className="border-l-[3px] border-brand-bright pl-5 mb-8">
                  <p className="text-xs font-bold text-brand-bright uppercase tracking-widest mb-1.5">Why It Matters</p>
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-cta text-white font-semibold text-sm rounded-xl hover:shadow-glow-cta hover:-translate-y-0.5 transition-all duration-300"
                >
              ...
              <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                <div className="rounded-2xl border border-gray-100 overflow-hidden shadow-card">
                  {/* Card header band */}
                  <div className="bg-gradient-brand px-6 py-4 flex items-center gap-2">
                    <service.icon className="w-4 h-4 text-white/80 flex-shrink-0" />
                    <h3 className="font-bold text-white text-sm">What You Get</h3>
                  </div>
                  ...
                  <div className="bg-white p-6 md:p-8">
                    <ul className="space-y-3">
                      {service.deliverables.map((item) => (
                        <li key={item} className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-5 h-5 rounded-md bg-brand-light flex items-center justify-center mt-0.5">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100">
                      <Link
                        href="/contact"
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-cta text-white font-semibold text-sm rounded-xl hover:shadow-glow-cta hover:-translate-y-0.5 transition-all duration-300"
                      >
                        Request a Quote
                        <ArrowRight className="w-4 h-4" />
                      </Link>
